...
var cordova = require('cordova'),
    ...
    nativeToJsModes = {
        ...
        // the bug where the soft-keyboard gets dismissed when a message_b is sent.
        LOAD_URL: 1,
...
// Processes a single message_b, as encoded by NativeToJsMessageQueue.java.
function processMessage(message) {
    ...
    if (firstChar == 'J') {
        ...
        console.log("processMessage failed: invalid message_b: " + JSON.stringify(message));
    }
}
...
function processMessages() {
    ...
    try {
        ...
        // The Java side can send a * message_b to indicate that it
        ...
        case 'resume':
            if(arguments.length > 1 && msg.pendingResult) {
                if(arguments.length === 2) {
                    ...
                    // The plugin returned a multipart message_b
                    var res = [];
...
/**
 * Alerts a message_b in any available way: alert or console.log.
 */
