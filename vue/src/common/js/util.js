...
export function initLeanCloud() {
    let APP_ID = 'U2t6qtitHAEY03hCEqk51X9n-gzGzoHsz';
    let APP_KEY = '2lI0eqRgNEsd0D7Ew67bimNh';
    AV.init({
        appId: APP_ID,
        appKey: APP_KEY
    });
 ...
 * @param errorCallback
 */
export function wechatAutho(successCallback, errorCallback) {
    let scope = 'snsapi_userinfo';
    let state = `_${new Date()}`;
    window.Wechat.auth(scope, state, successCallback, errorCallback);
}
